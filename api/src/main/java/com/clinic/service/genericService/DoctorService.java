...
//    }
    ...
    public String photoName(MultipartFile file) throws IOException {
        String root="C:\\Users\\BiSAl MhRzn\\Desktop\\final clinic";
        ...
        File file2=new File("C:\\Users\\BiSAl MhRzn\\Desktop\\final clinic\\clinic\\ui\\app\\upload\\image"+rand.nextInt(1000)+"."+ex);
